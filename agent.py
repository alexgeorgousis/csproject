...
class Agent:
	def __init__(self):
		...
		self.m = 10                   # individual length (number of actions)
		self.max_gens = 100            # maximum num of gens to evolve
		self.gens = []
		self.final_agent = ""         # best individual of last generation
		self.reproduction_ratio = 20  # amount of individuals generated by reproduction
		self.mutation_ratio = 40      # amount of individuals to mutate
		self.crossover_ratio = 40     # amount of individuals to crossover
	...
	def pop_fit(self, pop, trials=10):
		pop_rewards = []
	...
	def evolve(self, pop):
		...
		# Reproduction
		for i in range(self.reproduction_ratio):
