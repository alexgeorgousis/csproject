from pendulum_improved import PendulumImproved
...
# Print average best-program fitness over all runs of the experiment
...
for i in range(len(best_programs)):
    print("Best program #{}".format(i+1))
    print([str(p) for p in best_programs[i]])
